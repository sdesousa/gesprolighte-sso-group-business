...
public class GpAccountantServiceTest {
	...
	@Test
	public void testUpdateAccountantWithSuccess() throws GesproBusinessException {
		//Given
		GpAccountant emp = new GpAccountant();
		Assert.assertNull(emp.getId());
		emp.setFileNumber("18023");
	...
	@Test
	public void testUpdateAccountantWithException() throws GesproBusinessException {
		// Given
