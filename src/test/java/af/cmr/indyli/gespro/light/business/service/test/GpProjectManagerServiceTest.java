...
public class GpProjectManagerServiceTest {
	...
	@Test
	public void testUpdateProjectManagerWithSuccess() throws GesproBusinessException {
		//Given
		GpProjectManager emp = new GpProjectManager();
		Assert.assertNull(emp.getId());
		emp.setFileNumber("18023");
	...
	@Test
	public void testUpdateProjectManagerWithException() throws GesproBusinessException {
		// Given
